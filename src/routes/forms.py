...
class RegisterForm(FlaskForm):
    name = StringField(
        label="Full Name:", validators=[Length(min=3, max=16), DataRequired()]
    )
    username = StringField(
        label="Username:", validators=[Length(min=4, max=16), DataRequired()]
    )
    ...
    password2 = PasswordField(
        ...
        validators=[EqualTo(fieldname="password1"), DataRequired()],
    )
...
class DeleteForm(FlaskForm):
    name = StringField(
        label="Name:", validators=[Length(min=3, max=16), DataRequired()]
    )
    secret_id = StringField(
        label="Secret:", validators=[Length(min=36, max=36), DataRequired()]
    )
